...
In May 2026 the post-migration "Apple-clone" styling was replaced with a dmesg / boot-log direction. See `docs/development.md` for the resulting component and styles layout. The migration above is preserved as historical context — the routes, content collection, sitemap, and RSS behavior described here all carry through unchanged.
