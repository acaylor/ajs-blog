...
go to _System Preferences_ -> _Security & Privacy_ -> _Privacy_ -> _Files and Folders_ -> Give Removable Volumes access to Terminal.
...
If using Ubuntu Linux and you want to configure wi-fi on the Pi, mount the sd card partition _system-boot_ after installing Ubuntu Linux and open the text file `network-config`
...
Press _Connect_ and you can log into the Pi with username and password from previous steps.
