...
Head here to [Download Windows 10 (microsoft.com)][2]. Launch the media creation tool, accept the EULA, and then select "Create installation media". Enter details for your locale settings. Next you can choose _ISO file_ and save it to your system. Avoid paradoxical thoughts of any chickens or eggs. We can also use this .iso image later on and to create USB installation media for other computers.
