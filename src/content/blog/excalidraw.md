...
You can make something appear hand-drawn _or_ appear clean and proportional.
...
If you use the hosted version: - Click Live Collaboration - Share the link - Work together in real time if you each have network access to each other
