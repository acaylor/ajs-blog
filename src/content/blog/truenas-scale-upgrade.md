...
You can easily upgrade from TrueNAS core to scale using the TrueNAS console. All you need to do is navigate to the updates menu which you can access from the dashboard by selecting _Check for Updates_ or navigate to the URL `/ui/system/update`

All you need to do is change the `Train` from TrueNAS Core to TrueNAS Scale.

![truenas_scale_migration](/images/truenas-scale-migration.png)
