...
For this first example, we can create a single terraform template file to start a simple web server container. In the file we must reference the _provider_ that defines docker related resources.
