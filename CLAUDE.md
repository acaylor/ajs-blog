...
Notes for future Claude agents working in this repo. The codebase is small enough that you can read the code; this file documents the parts that are not obvious from reading.
